...
{
	public static class AccountsManagerContextSeed
	{
        public static async Task SeedAsync(this AccountsManagerContext context)
        {
            ...
            await context.Users.AddRangeAsync(adminUser, userUser, userUser2);
            await context.SaveChangesAsync();
            await context.UsersRoles.AddRangeAsync(new UserRole { Role = adminRole, User = adminUser },
                ...
                new UserRole { Role = userRole, User = userUser2 });
            await context.SaveChangesAsync();
